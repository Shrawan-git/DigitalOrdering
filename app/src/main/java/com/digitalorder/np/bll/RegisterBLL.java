...
public class RegisterBLL {
    ...
    public boolean signupUser(String name, String email, String phone, String password, String image, String gender){
        Users users = new Users(name, email, phone, password, image, gender);
